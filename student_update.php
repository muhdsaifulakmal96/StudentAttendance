    ...
    <form method="post" role="form" action="student_update.php?std_roll_no=<?php echo $key['std_roll_no']; ?>">
      ...
      <div class="container">
       ...
       <div class="col-lg-4">
          <div class="form-group">
            ...
            <input type="text" name="add" class="form-control"  id="add" placeholder="Your ID please" rows="3" value="<?php echo $key['address']; ?>" >
          </div>
       </div>
       </div>
     </div><!-- col-container-->
      ...
      <div class="form-group">
          ...
          <label for="program"  class="col-sm-2 control-label">Program</label>
		   <input type="text" class="form-control" id="program" placeholder="Program" name="program" value="<?php echo $key['Program']; ?>">
          </div>  
          </div>
        </div>
          </div>
